...
public class P01_Cookie extends TestBase {
    /*
                                    Cookies(Çerezler)
    ...
    public void test01() throws InterruptedException {
        ...
        for (Cookie c:cookies){
           ...
           // cookies.stream().forEach(t-> System.out.println(t.getName()+" "+t.getValue()));//lamda
        }
        //Yeni bir cookie ekleyiniz
        ...
        cookies2.stream().forEach(t-> System.out.println(t.getName()+" "+t.getValue()));//lamda
